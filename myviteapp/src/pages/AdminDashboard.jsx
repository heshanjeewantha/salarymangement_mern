    ...
    <div style={{ minHeight: '100vh', width: '100vw', background: 'linear-gradient(135deg, #e0e7ff 0%, #f3f4f6 100%)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ marginTop: '2rem', display: 'flex', flexDirection: 'row', gap: '2rem', justifyContent: 'center', alignItems: 'center' }}>
          ...
          >
              <span role="img" aria-label="salary" style={{ fontSize: '2.5rem', marginRight: '1rem' }}>�</span>
              <span style={{ fontWeight: '600', letterSpacing: '1px' }}>Salary Table</span>
          </button>
            <button style={{
              padding: '1rem 2.5rem',
              fontSize: '1.5rem',
            ...
            >
              <span role="img" aria-label="leave status" style={{ fontSize: '2.5rem', marginRight: '1rem' }}>�</span>
              <span style={{ fontWeight: '600', letterSpacing: '1px' }}>Leave Status</span>
            </button>
        </div>
      </div>
      <Footer />
